...
/**
 * Guard component that shows a message when Auto-Claude is not initialized.
 * Used to prevent configuration of features that require Auto-Claude setup.
 */
